...
function NavigationMenu2({ className, children, viewport = true, ...props }) {
  return (
...
function NavigationMenuTrigger2({ className, children, ...props }) {
  ...
  return (
    <NavigationMenuPrimitive.Trigger
      ...
      className={cn(navigationMenuTriggerStyle2(), "group", className)}
      {...props}
    >
      {children}{" "}
      <ChevronDownIcon
...
export {
  ...
  NavigationMenuLink2,
  NavigationMenuIndicator2,
  NavigationMenuViewport2,
