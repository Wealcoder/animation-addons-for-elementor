...
export function fadeFromAt(s, bp) {
	return valueAt(s, 'aae_anim_fade_from', bp) ?? 'bottom';
}
...
export function showFadeOffset(s, bp) {
	console.log('showFadeOffset', s, bp);
	console.log('showFadeOffset', { isFade: isFade(s, bp), fadeFromAt: fadeFromAt(s, bp) });
