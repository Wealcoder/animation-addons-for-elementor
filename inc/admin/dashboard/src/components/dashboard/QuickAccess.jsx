...
const AccessData = [
  {
    ...
    icon: <RiSettings2Line size={22} color="#46A1FF" />,
  },
  {
    title: "Theme Builder",
    subTitle: "Customize theme builder",
    url: WCF_ADDONS_ADMIN.theme_builder_url,
    icon: <RiLayout3Line size={22} color="#7772FC" />,
  },
  {
    title: "Pro Widget",
    subTitle: "Customize pro widgets",
    url: "",
    icon: <RiVipCrown2Line size={22} color="#FFA132" />,
  },
  {
    title: "Popup",
    subTitle: "Customize popups",
    url: "",
    icon: <SquareArrowUp size={22} color="#A281FF" />,
  },
  {
    title: "Custom Icons",
