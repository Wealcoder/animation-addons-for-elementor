...
const COUNT_CLASS = 'aae-a-social-share-main-item__count';
...
const initSocialShare = (container) => {
	...
	const items = container.querySelectorAll('.aae-a-social-share-main-item');
...
register({
	elementType: 'e-aae-a-social-share-main',
	id: 'aae-a-social-share-main-handler',
	callback: ({ element }) => {
		
		const container = element.classList && element.classList.contains('aae-a-social-share-main')
			? element
			: element.querySelector('.aae-a-social-share-main');
		if (container) {
