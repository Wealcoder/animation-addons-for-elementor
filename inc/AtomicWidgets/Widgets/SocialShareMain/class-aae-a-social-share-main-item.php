...
/**
 * Single social share item inside AAE_A_Social_Share_Main.
 *
 * Locked composite child tree per item:
 *   1. Atomic_Svg       (icon — class `aae-a-social-share-main-item-icon`)
 *   2. Atomic_Paragraph (title — class `aae-a-social-share-main-item-title`)
 *
 ...
 */
class AAE_A_Social_Share_Main_Item extends Atomic_Element_Base {

	use Has_Element_Template;

	const BASE_STYLE_KEY = 'base';

	public static $widget_description = 'A single social share item — icon + title — inside an AAE Social Share Main parent.';
	...
	public function get_title() {
		return esc_html__( 'Social Share Main Item', 'animation-addons-for-elementor' );
	}
	...
	public static function build_default_inner_children( string $vendor = 'facebook', string $label = 'Facebook' ): array {
		...
		//    is what renders.
		$svg_settings = [
			'classes' => Classes_Prop_Type::generate( [ 'aae-a-social-share-main-item-icon' ] ),
		];
		...
		$title = Atomic_Paragraph::generate()
			...
			->settings( [
				'classes'   => Classes_Prop_Type::generate( [ 'aae-a-social-share-main-item-title' ] ),
	...
	protected function get_templates(): array {
		return [
			'elementor/elements/aae-a-social-share-main-item' => __DIR__ . '/aae-a-social-share-main-item.html.twig',
		];
	}
	...
	public static function get_vendor_svg_url( $vendor ) {
		...
		return WCF_ADDONS_URL . 'inc/AtomicWidgets/Widgets/SocialShareMain/assets/svg/' . $vendor . '.svg';
	}
