<?php
/**
 * AAE Loop Next — pagination "Next" container (Pro replica).
 *
...
class AAE_A_Loop_Next extends Atomic_Element_Base {
	...
	public function get_title() {
		return esc_html__( 'Next', 'animation-addons-for-elementor' );
	}
	...
	protected function define_default_children() {
		...
		// Text label first, then the arrow icon (Next › ).
		$children[] = [
			'elType'          => 'widget',
			...
			'settings'        => [
				'paragraph' => [
					'$$type' => 'html-v3',
					'value'  => [
						'content'  => [ '$$type' => 'string', 'value' => __( 'Next', 'animation-addons-for-elementor' ) ],
						'children' => [],
					],
				],
	...
	protected function get_templates(): array {
		return [
			'elementor/elements/aae-a-loop-next' => __DIR__ . '/aae-a-loop-nav.html.twig',
		];
	}

	protected function build_template_context(): array {
		return array_merge( $this->build_base_template_context(), [ 'nav_role' => 'next' ] );
	}
}
