...
class Aaeaddon_A_Slider_Percentage extends Atomic_Widget_Base {
	use Has_Template;
	...
	public function get_keywords() {
		return [ 'slider', 'percentage', 'progress', 'atomic' ];
	}
	...
	protected function get_templates(): array {
		return [
			'elementor/elements/aae-a-slider-percentage' => __DIR__ . '/aae-a-slider-percentage.html.twig',
		];
	}
}
