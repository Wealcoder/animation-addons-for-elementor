...
class Aaeaddon_A_Slider_Dot extends Atomic_Widget_Base {
	use Has_Template;

	const BASE_STYLE_KEY = 'base';

	public static $widget_description = 'Single pagination dot for the nested slider.';
	...
	public function get_title() {
		return esc_html__( 'Slider Dot', 'animation-addons-for-elementor' );
	}
	...
	public function get_keywords() {
		return [ 'slider', 'dot', 'pagination', 'atomic' ];
	}
	...
	protected function define_base_styles(): array {
		$styles = [
			'width'         => Size_Prop_Type::generate( [ 'size' => 9, 'unit' => 'px' ] ),
			'height'        => Size_Prop_Type::generate( [ 'size' => 9, 'unit' => 'px' ] ),
	...
	protected function get_templates(): array {
		return [
			'elementor/elements/aae-a-slider-dot' => __DIR__ . '/aae-a-slider-dot.html.twig',
		];
	}
}
