...
class Aaeaddon_A_Slider_Total extends Atomic_Widget_Base {
	
	use Has_Template;

	const BASE_STYLE_KEY = 'base';

	public static $widget_description = 'Shows the total number of slides.';
	...
	public static function get_element_type(): string {
		return 'e-aae-a-slider-total';
	}

	public function get_title() {
		return esc_html__( 'Slider Total', 'animation-addons-for-elementor' );
	}
	...
	public function get_keywords() {
		return [ 'slider', 'total', 'number', 'atomic' ];
	}
	...
	protected function get_templates(): array {
		return [
			'elementor/elements/aae-a-slider-total' => __DIR__ . '/aae-a-slider-total.html.twig',
		];
	}
}
