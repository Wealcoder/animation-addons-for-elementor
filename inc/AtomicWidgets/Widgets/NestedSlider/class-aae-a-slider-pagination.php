...
class Aaeaddon_A_Slider_Pagination extends Atomic_Element_Base {
	...
	protected function define_base_styles(): array {
		$styles = [
			...
			// The dots sat flush against the track with nothing between them.
			// `margin-block-start` alone is not a schema property; `margin` is.
	...
	protected function define_default_children() {
		return [
			Aaeaddon_A_Slider_Dot::generate()
