...
class Aaeaddon_A_Slider_Nav_Next extends Atomic_Element_Base {
			...
			\Elementor\Modules\AtomicWidgets\Elements\Atomic_Svg\Atomic_Svg::generate()
				->settings( [
					...
					'svg' => \Elementor\Modules\AtomicWidgets\PropTypes\Svg_Src_Prop_Type::generate( [
						'id' => null,
						'url' => \Elementor\Modules\AtomicWidgets\PropTypes\Url_Prop_Type::generate( AAEADDON_URL . 'inc/AtomicWidgets/Widgets/NestedSlider/assets/icon/next.svg' ),
					] ),
				] )
				->build()
		];
	...
	protected function define_base_styles(): array {
		$styles = [
			...
			'inset-inline-end' => Size_Prop_Type::generate( [ 'size' => 16, 'unit' => 'px' ] ),
