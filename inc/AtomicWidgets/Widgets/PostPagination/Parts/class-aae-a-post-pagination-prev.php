 ...
 *
 * Structural container (like Aaeaddon_A_Loop_Prev) seeding an arrow icon (reuses
 * Aaeaddon_A_Loop_Arrow directly rather than duplicating it) + a text label, both
...
class Aaeaddon_A_Post_Pagination_Prev extends Atomic_Element_Base {
	...
	protected function define_default_children() {
		...
		if ( self::type_registered( 'e-aae-a-post-pagination-preview' ) ) {
			$children[] = Aaeaddon_A_Post_Pagination_Preview::generate()
				...
				->children( Aaeaddon_A_Post_Pagination_Preview::build_default_inner_children( 'prev' ) )
				->build();
		}
