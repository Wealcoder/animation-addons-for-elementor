...
/**
 * AAE Toggle Switcher — Pane Title. A single bold pane heading. Its own
 * widget type exists ONLY so it can carry its own fixed typography via
 * define_base_styles() — see class-aae-a-toggle-switcher-tab.php's sibling
...
class AAE_A_Toggle_Pane_Title extends Atomic_Widget_Base {
	...
	public static $widget_description = 'Internal pane-title label used by the AAE Toggle Pane.';

	public static function get_element_type(): string {
		return 'e-aae-a-toggle-pane-title';
	}

	public function get_title() {
		return esc_html__( 'Toggle Pane Title', 'animation-addons-for-elementor' );
	}

	public function get_keywords() {
		return [ 'toggle', 'pane', 'title', 'heading', 'atomic' ];
	}
	...
	protected static function define_props_schema(): array {
		return [
			...
			'text' => Html_V3_Prop_Type::make()
				...
				->description( 'The pane title text.' ),
	...
	protected function get_templates(): array {
		return [
			'elementor/elements/aae-a-toggle-pane-title' => __DIR__ . '/aae-a-toggle-pane-title.html.twig',
		];
	}
}
