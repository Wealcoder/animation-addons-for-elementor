...
require_once __DIR__ . '/class-aae-a-timeline-main-item.php';

use WCF_ADDONS\AtomicWidgets\Widgets\TimelineMain\AAE_A_Timeline_Main_Item;

class AAE_A_Timeline_Main extends Atomic_Element_Base {
	...
	public function get_title() {
		return esc_html__( 'AAE Timeline Main', 'animation-addons-for-elementor' );
	}
	...
	protected function define_default_children() {
		...
		foreach ( $items as $index => $item ) {
			$children[] = AAE_A_Timeline_Main_Item::generate()
				->editor_settings( [ 'title' => 'Item ' . ( $index + 1 ) ] )
				->children(
					AAE_A_Timeline_Main_Item::build_default_inner_children(
						$item['date'],
						$item['number'],
						$item['title'],
						$item['desc']
		...
		$children[] = Atomic_Paragraph::generate()
			...
			->settings( [
				'classes'   => Classes_Prop_Type::generate( [ 'aae-a-timeline-main-spine' ] ),
	...
	protected function define_allowed_child_types() {
		return [ 'e-aae-a-timeline-main-item', 'e-paragraph', 'e-divider' ];
	}
	...
	protected function get_templates(): array {
		return [
			'elementor/elements/aae-a-timeline-main' => __DIR__ . '/aae-a-timeline-main.html.twig',
		];
	}
}
