...
/**
 * AAE Social Share — composite atomic widget.
 *
 * Structure:
 *   AAE_A_Social_Share (parent — <ul>)
 *     ├─ AAE_A_Social_Share_Item (locked — Facebook)
 *     │    ├─ Atomic_Svg       (icon)
 *     │    └─ Atomic_Paragraph (title)
 *     ├─ AAE_A_Social_Share_Item (locked — Twitter)
 *     ├─ AAE_A_Social_Share_Item (locked — LinkedIn)
 *     └─ AAE_A_Social_Share_Item (locked — Instagram)
 *
...
class AAE_A_Social_Share extends Atomic_Element_Base {
	...
	protected function define_atomic_controls(): array {
		return [
			Section::make()
				->set_label( __( 'Social Share', 'animation-addons-for-elementor' ) )
				->set_id( 'content' )
				->set_items( [
