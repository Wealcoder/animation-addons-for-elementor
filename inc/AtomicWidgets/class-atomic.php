...
final class Atomic
{
	...
	private const WIDGET_PARENT_MAP = [
		...
		// Video Popup — deliberately its own family, never sharing Parts
		// with Video above (see class-aae-a-video-popup-panel.php).
		'aae-a-video-popup-trigger'    => 'aae-a-video-popup',
		'aae-a-video-popup-overlay'    => 'aae-a-video-popup',
		'aae-a-video-popup-close'      => 'aae-a-video-popup',
		'aae-a-video-popup-panel'      => 'aae-a-video-popup',
		'aae-a-video-popup-player'     => 'aae-a-video-popup',
		'aae-a-video-popup-playbtn'    => 'aae-a-video-popup',
	...
	private function register_widget_definitions(): void
	{
		$this->widgets_registry = [
			...
			*/
			...
			'aae-a-video-popup' => [
				'label'        => 'Video Popup',
				'description'  => 'A spinning circular trigger that opens a popup video player — same YouTube/Vimeo/hosted/Dailymotion/VideoPress sources and custom controls bar as the AAE Video widget.',
			...
			'aae-a-video-popup-trigger' => [
				'label'        => 'Video Popup — Trigger',
				'description'  => 'Internal spinning trigger button used by the Video Popup widget.',
				'icon'         => 'eicon-play',
				'is_pro'       => false,
				'is_extension' => false,
				'is_upcoming'  => false,
				'is_internal'  => true,
				'default'      => true,
				'keywords'     => [ 'video', 'popup', 'trigger', 'internal' ],
				'category'     => 'video',
				'order'        => 23,
				'demo_url'     => '',
				'doc_url'      => '',
			...
			'aae-a-video-popup-overlay' => [
				'label'        => 'Video Popup — Overlay',
				'description'  => 'Internal backdrop layer used by the Video Popup widget.',
				'icon'         => 'eicon-square',
				'is_pro'       => false,
				'is_extension' => false,
				'is_upcoming'  => false,
				'is_internal'  => true,
				'default'      => true,
				'keywords'     => [ 'video', 'popup', 'overlay', 'backdrop', 'internal' ],
				'category'     => 'video',
				'order'        => 24,
				'demo_url'     => '',
				'doc_url'      => '',
			...
			'aae-a-video-popup-close' => [
				'label'        => 'Video Popup — Close',
				'description'  => 'Internal close button used by the Video Popup widget.',
				'icon'         => 'eicon-close',
				'is_pro'       => false,
				'is_extension' => false,
				'is_upcoming'  => false,
				'is_internal'  => true,
				'default'      => true,
				'keywords'     => [ 'video', 'popup', 'close', 'internal' ],
				'category'     => 'video',
				'order'        => 25,
				'demo_url'     => '',
				'doc_url'      => '',
			...
			'aae-a-video-popup-panel' => [
				'label'        => 'Video Popup — Panel',
				'description'  => 'Internal popup box (video source/playback/controls settings) used by the Video Popup widget.',
				'icon'         => 'eicon-video-playlist',
				'is_pro'       => false,
				'is_extension' => false,
				'is_upcoming'  => false,
				'is_internal'  => true,
				'default'      => true,
				'keywords'     => [ 'video', 'popup', 'panel', 'internal' ],
				'category'     => 'video',
				'order'        => 26,
				'demo_url'     => '',
				'doc_url'      => '',
			...
			'aae-a-video-popup-player' => [
				'label'        => 'Video Popup — Player',
				'description'  => 'Internal video-engine sub-element used by the Video Popup widget.',
				'icon'         => 'eicon-video-playlist',
				'is_pro'       => false,
				'is_extension' => false,
				'is_upcoming'  => false,
				'is_internal'  => true,
				'default'      => true,
				'keywords'     => [ 'video', 'popup', 'player', 'internal' ],
				'category'     => 'video',
				'order'        => 27,
				'demo_url'     => '',
				'doc_url'      => '',
			...
			'aae-a-video-popup-playbtn' => [
				'label'        => 'Video Popup — Play Button',
				'description'  => 'Internal play-button trigger used by the Video Popup widget.',
				'icon'         => 'eicon-play',
				'is_pro'       => false,
				'is_extension' => false,
				'is_upcoming'  => false,
				'is_internal'  => true,
				'default'      => true,
				'keywords'     => [ 'video', 'popup', 'play', 'button', 'internal' ],
				'category'     => 'video',
				'order'        => 28,
				'demo_url'     => '',
				'doc_url'      => '',
	...
	private function build_available_widgets()
	{
		...
		'aae-a-video-popup' => [
			'class'         => '\WCF_ADDONS\AtomicWidgets\Widgets\VideoPopup\AAE_A_Video_Popup',
			'file'          => 'Widgets/VideoPopup/class-aae-a-video-popup.php',
			'script_handle' => 'aae-a-video-popup-js',
			'script_path'   => '/assets/atomic/js/video-popup.js',
			'has_script'    => true,
			'style_handle'  => 'aae-a-video-popup-css',
			'style_path'    => '/assets/atomic/css/video-popup.css',
		],

		'aae-a-video-popup-trigger' => [
			'class'      => '\WCF_ADDONS\AtomicWidgets\Widgets\VideoPopup\AAE_A_Video_Popup_Trigger',
			'file'       => 'Widgets/VideoPopup/Parts/class-aae-a-video-popup-trigger.php',
			'has_script' => false,
		],

		'aae-a-video-popup-overlay' => [
			'class'      => '\WCF_ADDONS\AtomicWidgets\Widgets\VideoPopup\AAE_A_Video_Popup_Overlay',
			'file'       => 'Widgets/VideoPopup/Parts/class-aae-a-video-popup-overlay.php',
			'has_script' => false,
		],

		'aae-a-video-popup-close' => [
			'class'      => '\WCF_ADDONS\AtomicWidgets\Widgets\VideoPopup\AAE_A_Video_Popup_Close',
			'file'       => 'Widgets/VideoPopup/Parts/class-aae-a-video-popup-close.php',
			'has_script' => false,
		],

		'aae-a-video-popup-panel' => [
			'class'      => '\WCF_ADDONS\AtomicWidgets\Widgets\VideoPopup\AAE_A_Video_Popup_Panel',
			'file'       => 'Widgets/VideoPopup/Parts/class-aae-a-video-popup-panel.php',
			'has_script' => false,
		],

		'aae-a-video-popup-player' => [
			'class'      => '\WCF_ADDONS\AtomicWidgets\Widgets\VideoPopup\AAE_A_Video_Popup_Player',
			'file'       => 'Widgets/VideoPopup/Parts/class-aae-a-video-popup-player.php',
			'has_script' => false,
		],

		'aae-a-video-popup-playbtn' => [
			'class'      => '\WCF_ADDONS\AtomicWidgets\Widgets\VideoPopup\AAE_A_Video_Popup_PlayBtn',
			'file'       => 'Widgets/VideoPopup/Parts/class-aae-a-video-popup-playbtn.php',
			'has_script' => false,
		],
