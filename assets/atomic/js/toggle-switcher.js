...
=======
!function(){const e=new Map;function t(t,s){const a=t.dataset.id||"";a&&e.set(a,s),t.querySelectorAll(".aae-ts-pane").forEach((e,t)=>{const a=s?1===t:0===t;e.classList.toggle("show",a),a?e.style.removeProperty("display"):e.style.setProperty("display","none","important")});const o=t.querySelector(".aae-ts-label-before"),l=t.querySelector(".aae-ts-label-after");o?.classList.toggle("active",!s),o?.classList.toggle("e--selected",!s),o?.setAttribute("aria-selected",String(!s)),l?.classList.toggle("active",s),l?.classList.toggle("e--selected",s),l?.setAttribute("aria-selected",String(s)),t.querySelectorAll(".aae-ts-switch").forEach(e=>e.classList.toggle("active",s))}function s(s){var a;if(!s.querySelectorAll(".aae-ts-pane").length)return!1;const o=s.dataset.id||"";return t(s,!!o&&null!==(a=e.get(o))&&void 0!==a&&a),!0}function a(){document.querySelectorAll(".aae-a-toggle-switcher").forEach(s)}document.addEventListener("click",s=>{const a=s.target.closest(".aae-ts-label-before, .aae-ts-label-after, .aae-ts-switch");if(!a)return;const o=a.closest(".aae-a-toggle-switcher");if(o)if(s.preventDefault(),a.classList.contains("aae-ts-label-before"))t(o,!1);else if(a.classList.contains("aae-ts-label-after"))t(o,!0);else{var l;const s=o.dataset.id||"";t(o,!(s&&null!==(l=e.get(s))&&void 0!==l&&l))}},!0),a();let o=0,l=0;const r=new MutationObserver(e=>{if(!function(e){for(const t of e)for(const e of t.addedNodes)if(1===e.nodeType&&(e.matches?.(".aae-a-toggle-switcher")||e.querySelector?.(".aae-a-toggle-switcher")||e.closest?.(".aae-a-toggle-switcher")))return!0;return!1}(e))return;const t=Date.now();if(t-l>1e3&&(l=t,o=0),o+=1,o>30)return r.disconnect(),console.warn("[AAE Toggle Switcher] DOM re-init loop exceeded 30 runs/second — disabling the live observer to avoid hanging the tab. Falling back to a periodic rescan every 2s."),void setInterval(a,2e3);r.disconnect(),a(),r.observe(document.body,{childList:!0,subtree:!0})});r.observe(document.body,{childList:!0,subtree:!0})}();
>>>>>>> atomic4
