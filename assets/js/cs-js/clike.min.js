! function(e) {
	...
	function D(e, t, n, r) {
		var o = e.indented;
		e.context && "statement" == e.context.type && "statement" != n && (o = e.context.indented), e.context = new L(o, t, n, r, null, e.context)
	}
	...
	M.defineMode("clike", function(e, a) {
		var i, l, s = e.indentUnit,
			c = a.statementIndentUnit || s,
			u = a.dontAlignCalls,
			o = a.keywords || {}, d = a.types || {}, f = a.builtin || {}, p = a.blockKeywords || {}, m = a.defKeywords || {}, h = a.atoms || {}, y = a.hooks || {}, g = a.multiLineStrings,
			k = !1 !== a.indentStatements,
			e = !1 !== a.indentSwitch,
			x = a.namespaceSeparator,
			b = a.isPunctuationChar || /[\[\]{}\(\),;\:\.]/,
			v = a.numberStart || /[\d\.]/,
			w = a.number || /^(?:0x[a-f\d]+|0b[01]+|(?:\d+\.?\d*|\.\d+)(?:e[-+]?\d+)?)(u|ll?|l|f)?/i,
			_ = a.isOperatorChar || /[+\-*&%=<>!?|\/]/,
		...
		function C(e, t) {
			...
			if ('"' == n || "'" == n) return t.tokenize = (a = n, function(e, t) {
			...
			if (e.eatWhile(S), x)
				for (; e.match(x);) e.eatWhile(S);
			r = e.current();
			return F(o, r) ? (F(p, r) && (i = "newstatement"), F(m, r) && (l = !0), "keyword") : F(d, r) ? "type" : F(f, r) || T && T(r) ? (F(p, r) && (i = "newstatement"), "builtin") : F(h, r) ? "atom" : "variable"
		}
		...
		function N(e, t) {
			a.typeFirstDefinitions && e.eol() && z(t.context) && (t.typeAtEndOfLine = E(e, t, e.pos))
		}
		return {
			...
			token: function(e, t) {
				var n = t.context;
				if (e.sol() && (null == n.align && (n.align = !1), t.indented = e.indentation(), t.startOfLine = !0), e.eatSpace()) return N(e, t), null;
				i = l = null;
				var r, o = (t.tokenize || C)(e, t);
				if ("comment" == o || "meta" == o) return o;
				if (null == n.align && (n.align = !0), ";" == i || ":" == i || "," == i && e.match(/^\s*(?:\/\/.*)?$/, !1))
					for (;
						"statement" == t.context.type;) P(t);
				else if ("{" == i) D(t, e.column(), "}");
				else if ("[" == i) D(t, e.column(), "]");
				else if ("(" == i) D(t, e.column(), ")");
				else if ("}" == i) {
					for (;
						"statement" == n.type;) n = P(t);
					for ("}" == n.type && (n = P(t));
						"statement" == n.type;) n = P(t)
				} else i == n.type ? P(t) : k && (("}" == n.type || "top" == n.type) && ";" != i || "statement" == n.type && "newstatement" == i) && D(t, e.column(), "statement", e.current());
				return "variable" == o && ("def" == t.prevToken || a.typeFirstDefinitions && E(e, t, e.start) && z(t.context) && e.match(/^\s*\(/, !1)) && (o = "def"), "def" == (o = y.token && void 0 !== (r = y.token(e, t, o)) ? r : o) && !1 === a.styleDefs && (o = "variable"), t.startOfLine = !1, t.prevToken = l ? "def" : o || i, N(e, t), o
			},
			indent: function(e, t) {
				if (e.tokenize != C && null != e.tokenize || e.typeAtEndOfLine && z(e.context)) return M.Pass;
				var n = e.context,
					r = t && t.charAt(0),
					o = r == n.type;
				if ("statement" == n.type && "}" == r && (n = n.prev), a.dontIndentStatements)
					for (;
						"statement" == n.type && a.dontIndentStatements.test(n.info);) n = n.prev;
				if (y.indent) {
					e = y.indent(e, n, t, s);
				...
				return "statement" == n.type ? n.indented + ("{" == r ? 0 : c) : !n.align || u && ")" == n.type ? ")" != n.type || o ? n.indented + (o ? 0 : s) + (o || !e || /^(?:case|default)\b/.test(t) ? 0 : s) : n.indented + c : n.column + (o ? 0 : 1)
			},
	...
	var t = "auto if break case register continue return default do sizeof static else struct switch extern typedef union for goto while enum const volatile inline restrict asm fortran",
		...
		o = "FOUNDATION_EXPORT FOUNDATION_EXTERN NS_INLINE NS_FORMAT_FUNCTION  NS_RETURNS_RETAINEDNS_ERROR_ENUM NS_RETURNS_NOT_RETAINED NS_RETURNS_INNER_POINTER NS_DESIGNATED_INITIALIZER NS_ENUM NS_OPTIONS NS_REQUIRES_NIL_TERMINATION NS_ASSUME_NONNULL_BEGIN NS_ASSUME_NONNULL_END NS_SWIFT_NAME NS_REFINED_FOR_SWIFT",
	...
	function h(e, t) {
		var n;
		return e.backUp(1), e.match(/^(?:R|u8R|uR|UR|LR)/) ? !! (n = e.match(/^"([^\s\\()]{0,16})\(/)) && (t.cpp11RawStringDelim = n[1], (t.tokenize = k)(e, t)) : e.match(/^(?:u8|u|U|L)/) ? !! e.match(/^["']/, !1) && "string" : (e.next(), !1)
	}
	...
	function x(e, t) {
		...
		r(t.keywords), r(t.types), r(t.builtin), r(t.atoms), n.length && (t.helperType = e[0], M.registerHelper("hintWords", e[0], n));
	...
	function v(r) {
		return function(e, t) {
			for (var n; n = e.next();) {
				...
				if ("/" == n && e.eat("*")) return t.tokenize = v(r + 1), t.tokenize(e, t)
			}
			return "comment"
		}
	}
	x(["text/x-csrc", "text/x-c", "text/x-chdr"], {
		...
		hooks: {
			...
			token: function(e, t, n) {
				if ("variable" == n && "(" == e.peek() && (";" == t.prevToken || null == t.prevToken || "}" == t.prevToken) && y(e.current())) return "def"
			}
		},
		namespaceSeparator: "::",
		modeProps: {
		...
		types: e("var byte short int long float double boolean char void Boolean Byte Character Double Float Integer Long Number Object Short String StringBuffer StringBuilder Void"),
		...
		defKeywords: e("class interface namespace record struct var"),
		typeFirstDefinitions: !0,
		atoms: e("true false null"),
		hooks: {
			"@": function(e, t) {
		...
		hooks: {
			...
			"'": function(e) {
				return e.match(/^(\\[^'\s]+|[^\\'])'/) ? "string-2" : (e.eatWhile(/[\w\$_\xa1-\uffff]/), "atom")
			},
			"=": function(e, t) {
				var n = t.context;
				return !("}" != n.type || !n.align || !e.eat(">")) && (t.context = new L(n.indented, n.column, n.type, n.info, null, n.prev), "operator")
			},
			"/": function(e, t) {
		...
		hooks: {
			...
			'"': function(e, t) {
				var a;
				return t.tokenize = (a = e.match('""'), function(e, t) {
					for (var n, r = !1, o = !1; !e.eol();) {
						...
						n = e.next(), !r && "$" == n && e.match("{") && e.skipTo("}"), r = !r && "\\" == n && !a
					}
	...
	x("text/x-ceylon", {
		...
		hooks: {
			...
			'"': function(e, t) {
				return t.tokenize = function a(i) {
					return function(e, t) {
						for (var n, r = !1, o = !1; !e.eol();) {
