! function(t) {
	...
	"use strict";
	n.defineOption("foldGutter", !1, function(t, o, e) {
		e && e != n.Init && (t.clearGutter(t.state.foldGutter.options.gutter), t.state.foldGutter = null, t.off("gutterClick", d), t.off("changes", u), t.off("viewportChange", l), t.off("fold", m), t.off("unfold", m), t.off("swapDoc", u), t.off("optionChange", a)), o && (t.state.foldGutter = new r(function(t) {
			!0 === t && (t = {});
			...
			return t
		}(o)), f(t), t.on("gutterClick", d), t.on("changes", u), t.on("viewportChange", l), t.on("fold", m), t.on("unfold", m), t.on("swapDoc", u), t.on("optionChange", a))
	});
	var c = n.Pos;
	...
	function s(t, o) {
		for (var e = t.findMarks(c(o, 0), c(o + 1, 0)), n = 0; n < e.length; ++n)
			if (e[n].__isFold) {
				var r = e[n].find(-1);
				if (r && r.line === o) return e[n]
			}
	}
	...
	function i(r, t, o) {
		var i = r.state.foldGutter.options,
			f = t - 1,
			d = r.foldOption(i, "minFoldSize"),
			a = r.foldOption(i, "rangeFinder"),
			u = "string" == typeof i.indicatorFolded && e(i.indicatorFolded),
			l = "string" == typeof i.indicatorOpen && e(i.indicatorOpen);
		r.eachLine(t, o, function(t) {
			++f;
			var o = null,
			...
			if (s(r, f)) {
				...
				var n = c(f, 0),
					n = a && a(r, n);
				if (n && n.to.line - n.from.line >= d) {
					if (l && e && l.test(e.className)) return;
					o = p(i.indicatorOpen)
				}
			}(o || e) && r.setGutterMarker(t, i.gutter, o)
		})
	}
	...
	function d(t, o, e) {
		...
		!n || e == (e = n.options).gutter && ((n = s(t, o)) ? n.clear() : t.foldCode(c(o, 0), e))
	}
