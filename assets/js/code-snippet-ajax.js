...
(function($) {
    ...
    var CodeSnippetAjax = {
        ...
        performAjaxSearch: function() {
            ...
            var codeType = $('input[name="code_type"]').val() || 'all';
            var currentPage = $('input[name="paged"]').val() || 1;
        ...
        createTableRow: function(snippet) {
            ...
            var row = '<tr>' +
                ...
                '</td>' +
                '<td class="visibility_list column-visibility_list">All</td>' +
                '<td class="load_location column-load_location">' +
                    '<span class="load-location">' + loadLocationText + '</span>' +
                '</td>' +
                ...
                '<td class="snippet_status column-snippet_status">' +
                    ...
                    '</label>' +
                '</td>' +
                '<td class="date_created column-date_created">' +
                    '<time datetime="' + snippet.date_modified + '">' + snippet.date_modified + '</time>' +
                '</td>' +
            '</tr>';
        ...
        handleFilterChange: function(link) {
            ...
            $('input[name="code_type"]').val(codeType);
            $('#s').val('');
