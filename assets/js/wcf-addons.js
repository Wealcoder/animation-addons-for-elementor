...
(function($) {
	...
	$(window).on('elementor/frontend/init', function() {
		...
		var ClickDrop = function ClickDrop($scope) {
			// Convert jQuery object to native DOM element
			var scopeEl = $scope[0]; // or $scope.get(0)

			var btn = scopeEl.querySelector(".aae-clickdrop-btn");
			var modal = scopeEl.querySelector(".aae-clickdrop-modal");
			if (!btn || !modal) return;
