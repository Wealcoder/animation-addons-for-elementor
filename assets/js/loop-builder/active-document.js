...
(function($) {
		...
		class AAE_ActiveDocumentHandler {
			...
			addEditorIndicatorWithControls() {
                ...
                / / Add class to body(optional) $('body').addClass('aae-template-editing-mode');
						};
					...
					lockBaseDocument() {
						...
						.custom - loop - container - $ {
							...
							.custom - loop - container - $ {
								activeDocument
						}.elementor - element - editable.elementor - element - overlay {
							display: block!important;
						}
							.custom - loop - container - $ {
								activeDocument
						}.elementor - element.elementor - element - edit - mode: hover.elementor - element - overlay {
							display: block!important;
							pointer - events: none!important;
						}`;
							...
							try {
								...
								if (typeof elementor !== 'undefined' && elementor.saver) {
									if (elementor.saver.save) {
										Promise.resolve(elementor.saver.save({
											status: 'publish'
										}))
											.then(resolve)
											.
